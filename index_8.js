...
const { log, formatPokemon, logHook, colors, getRate } = require("../utils/utils");
      ...
      if (
        ...
        if (message.content.includes("The pokémon is")) {
          ...
          if (message.content.includes(this.client.user.id)) {
            ...
            if (loggable.length > 0 && loggable[0] != `Regular`) {
              caught.rarity = caught.shiny?"Shiny": rarity
              caught.user = this.client.user.tag
                ...
                .setFields([
                  ...
                  },
                  {
                    ...
                    value: `**Name:** \`${
                      ...
                      new Date() / 1000
                    )}:R>\n**Speed:** \`${getRate(started, getTotalCatches())}\`P/s\n**Total:** \`${
                      this.stats.catches
                    }\``,
                    inline: true,
                  },
          ...
          hook.send({
            content: `@here you are all rigged... Solve this broskie`,
          });
        } else if (
        ...
        if (message.embeds.length > 0) {
          ...
          if (title.includes("has appeared")) {
            ...
            const apiKey = "zxclan";
            const creatorusername = 'edvardcarvontop'
